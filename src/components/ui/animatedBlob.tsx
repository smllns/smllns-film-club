// animated blob used for background
'use client';
...
void main() {
    float distort = 2.0 * vDisplacement * u_intensity * sin(vUv.y * 10.0 + u_time);
     vec3 color = mix(u_color1, u_color2, distort) * 0.9;
...
export const Blobs: React.FC = () => {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      u_color1: { value: new Color('#d588ff') },
      u_color2: { value: new Color('#50ffff') },
    }),
    []
  );
