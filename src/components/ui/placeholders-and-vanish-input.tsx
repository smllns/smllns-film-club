// reusable search input with vanishing placeholders
'use client';
...
export function PlaceholdersAndVanishInput({
  ...
  return (
    ...
    >
      ...
      {loading && (
        <motion.div
          className='absolute right-2 top-1/2 z-20 -translate-y-1/2 h-8 w-8 flex items-center justify-center text-neutral-800'
          animate={{ rotate: 360 }}
